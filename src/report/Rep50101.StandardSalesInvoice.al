...
report 50101 "Standard Sales - Invoice"
{
        ...
        dataitem(Header; "Sales Invoice Header")
        {
            ...
            dataitem(Line; "Sales Invoice Line")
            {
                ...
                var
                    ...
                    // BaseConvertImpl: Codeunit "Base64 Convert Impl.";
                    Base64: Text;
                    VATAmountText: Text;
                    myDecimal: Decimal;
                    ...
                    TxtToHexadeical: Codeunit "Text To Hexadeical";
                    sellerName: Text;
                    sellerVAT: Text;
                    PostingDate: Text;
                    InvAmt: Text;
                ...
                begin
                    ...
                    // EncodeStr := QRImage.GenQRCode(Header."No.");
                    QRCode := TxtToHexadeical.TextToHexForLength();

                    // Message(QRCode);
                    // VATAmountText := Format(TotalAmountVAT, 0, AutoFormat.ResolveAutoFormat(Enum::"Auto Format"::AmountFormat, Header."Currency Code"));
                    // Evaluate(VATAmountDec, VATAmountText);
                    // RoundInvAmt := Round(Line."Amount Including VAT", 0.001, '>');
                    // RoundVATAmt := Round(TotalAmountVAT, 0.001, '>');

                    BarcodeFontProvider2D := Enum::"Barcode Font Provider 2D"::IDAutomation2D;
                    BarcodeSymbology2D := Enum::"Barcode Symbology 2D"::"QR-Code";
                    Base64 := Base64Convert.ToBase64(QRCode.ToLower());
                    Message(QRCode);
                    Message(Base64);
                    EncodeStr := BarcodeFontProvider2D.EncodeFont(Base64, BarcodeSymbology2D);
                end;
    ...
    rendering
    {
        ...
        {
            Type = RDLC;
            LayoutFile = './src/Layout/StandardSalesInvoice.rdl';
